...
namespace Apache.Qpid.Proton.Buffer
{
   ...
   public interface IProtonCompositeBuffer : IProtonBuffer
   {
      ...
      /// to accommodate buffer writes a default buffer allocator will be used.
      /// </summary>
      /// <param name="maxCapacity">The maximum capacity this composite buffer can grow to</param>
      /// <returns>a new empty composute buffer instance.</returns>
      /// <exception cref="NotImplementedException"></exception>
      public static IProtonCompositeBuffer Compose(long maxCapacity)
      {
         return new ProtonCompositeBuffer(ProtonByteBufferAllocator.Instance, null, maxCapacity);
      }
