...
namespace Apache.Qpid.Proton.Buffer
{
   ...
   public class ProtonCompositeBufferTest : ProtonAbstractByteBufferTests
   {
      ...
      {
         ProtonCompositeBuffer buffer1 = (ProtonCompositeBuffer)IProtonCompositeBuffer.Compose();
         ProtonCompositeBuffer buffer2 = (ProtonCompositeBuffer)IProtonCompositeBuffer.Compose();
         ProtonCompositeBuffer buffer3 = (ProtonCompositeBuffer)IProtonCompositeBuffer.Compose();
      ...
      {
         ProtonCompositeBuffer appendTo = (ProtonCompositeBuffer)IProtonCompositeBuffer.Compose();
         byte[] data1 = new byte[] { 255, 255, 0, 1, 2, 3, 4, 5 };
         byte[] data2 = new byte[] { 255, 255, 255, 0, 1, 2, 3, 4, 5 };
